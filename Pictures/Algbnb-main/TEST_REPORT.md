...
- API QA: 36/36 scenarios OK.
- Audit navigateur: 15/15 scenarios OK.
- MVC boundary check: OK.
- Build front: OK.
- Lint front: OK avec warnings React Hook connus si non encore corriges.

## Scenarios Couverts

- Healthcheck API et connexion PostgreSQL.
- Auth inscription, doublon, connexion, providers et reset password.
